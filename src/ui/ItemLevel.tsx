...
const itemIcons: {[key: string]: string} = {
  [ItemType.Weapon]: require("src/assets/dd/images/panels/icons_equip/trinket/inv_trinket+swordsmans_crest.png"),
  [ItemType.Armor]: require("src/assets/dd/images/panels/icons_equip/trinket/inv_trinket+cadogans_shield.png")
};
