...
export class BarkTooltip extends AppStateComponent<{
  ...
  static letterSound = {src: [require("src/assets/dd/audio/ui_shr_text_loop.ogg")], volume: 0.4};
  static popupSound = {src: [require("src/assets/dd/audio/ui_shr_text_popup.ogg")]};
