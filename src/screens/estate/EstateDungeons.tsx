...
export class EstateDungeons extends AppStateComponent<{path: Path}> {
  ...
  render () {
    ...
    return (
      <EstateTemplate
        background={require("src/assets/dd/images/campaign/town/quest_select/quest_select.background.png")}
        lineupFeaturesInRoster={true}
        path={this.props.path}
        backPath="estateOverview"
        continueCheck={() => this.checkLineupBeforeContinue()}
        continueSound={{src: require("src/assets/dd/audio/ui_town_button_provision.ogg"), volume: 0.7}}
