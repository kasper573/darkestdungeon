...
export class EstateProvision extends AppStateComponent<{path: Path}> {
  ...
  render () {
    return (
      <EstateTemplate
        background={require("src/assets/dd/images/campaign/town/provision/provision.background.png")}
        path={this.props.path}
        backPath="estateDungeons"
        roster={false}
        inventory={false}
        continueCheck={() => this.checkItemsBeforeContinue()}
        continueSound={{src: require("src/assets/dd/audio/ui_town_button_setoff.ogg"), volume: 0.7}}
