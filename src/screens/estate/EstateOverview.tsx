...
const sounds = {
  continueToMap: {src: require("src/assets/dd/audio/ui_town_button_embark.ogg"), volume: 0.7},
  showBuilding: {src: require("src/assets/dd/audio/ui_town_char_rollover_03.ogg"), volume: 1.5}
};
  ...
  render () {
    return (
      <EstateTemplate
        ...
        background={require("src/assets/dd/images/loading_screen/loading_screen.town_visit.png")}
