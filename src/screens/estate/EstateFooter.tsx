...
const sounds = {
  heirloomsChanged: {src: require("src/assets/dd/audio/ui_dun_loot_take_estsatecurrency.ogg"), volume: 0.5},
  goldChanged: [
    {src: require("src/assets/dd/audio/ui_town_coins_ring_08.ogg"), volume: 1},
    {src: require("src/assets/dd/audio/ui_town_coins_ring_04.ogg"), volume: 1},
    {src: require("src/assets/dd/audio/ui_town_coins_sprk_sml_05.ogg"), volume: 1},
    {src: require("src/assets/dd/audio/ui_town_coins_sprk_sml_10.ogg"), volume: 1},
    {src: require("src/assets/dd/audio/ui_town_coins_sprk_sml_08.ogg"), volume: 1}
  ]
};
      ...
      <ScreenFooter behind={<HeirloomTrader isVisible={this.showHeirloomTrader}/>}>
        <Row valign="center" style={{flex: 1}}>
          ...
          <TooltipArea tip="Trade heirlooms">
            <Icon
              src={require("src/assets/dd/images/campaign/town/heirloom_exchange/he_icon_idle.png")}
