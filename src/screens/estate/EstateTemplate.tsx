          ...
          <Row classStyle={styles.headerContent}>
            {this.mayGoBack && (
              <Icon
                ...
                src={require("src/assets/dd/images/shared/progression/progression_back.png")}
                onClick={() => this.goBack()}
              />
            )}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    background: `url(${require("src/assets/dd/images/campaign/town/estate_title/estate_nameplate.png")})`,
