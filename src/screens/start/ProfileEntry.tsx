...
const difficultyIcons = {
  [Difficulty.Radiant]: require("src/assets/dd/images/modes/radiant/fe_flow/save_icon.png"),
  [Difficulty.Stygian]: require("src/assets/dd/images/modes/new_game_plus/fe_flow/save_icon.png"),
  [Difficulty.Darkest]: require("src/assets/dd/images/modes/base/fe_flow/save_icon.png")
};

const deleteIcon = require("src/assets/dd/images/fe_flow/nukesave_button.png");
